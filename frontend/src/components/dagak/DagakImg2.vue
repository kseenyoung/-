    ...
    >
      ...
      <g v-if="props.gakLength === 1">
        <circle
          ...
          stroke-width="2"
        />
        <text style="font-size: 100%;font-weight: bold;" :x="pizzaSlices[0].labelX+4" :y="pizzaSlices[0].labelY-30" text-anchor="middle" dominant-baseline="left" fill="black">{{ pizzaSlices[0].label }}</text>
      </g>
      ...
      <g v-else-if="props.gakLength === 2">
        ...
        <path
          ...
          stroke-width="1"
        />
        <text style="font-size: 100%;font-weight: bold;" :x="slice.labelX+4" :y="slice.labelY-30" text-anchor="middle" dominant-baseline="left" fill="black">{{ slice.label }}</text>
      </g>
      </g>
      ...
      <g v-else v-for="(slice, index) in pizzaSlices" :key="index" >
        ...
        <text style="font-size: 90%;font-weight: bold;" :x="slice.labelX" :y="slice.labelY" text-anchor="middle" dominant-baseline="left" fill="black">{{ slice.label }}</text>
      </g>
    </svg>
  </template>
