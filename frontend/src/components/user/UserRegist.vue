  ...
  <div class="container">
    ...
    <div class="form-con">
      <div class="input-con row mb-4">
          <label for="id" class="col-sm-2 col-form-label">아이디<span>*</span></label>
          <div class="col-sm-10">
              <input class="form-control" type="text" id="id" placeholder="아이디를 입력하세요" required autocomplete="off" 
              v-model="id" :class="{ 'is-valid': idFlag, 'is-invalid': !idFlag }">
              <div v-if="!isValidId" class="form-text">영소문자와 숫자 조합의 5~15자리를 사용하세요</div>
              <div class="btn-dup">
      ...
      <div class="input-con row mb-4">
          <label for="password" class="col-sm-2 form-label">비밀번호<span>*</span></label>
          <div class="col-sm-10">
              <input class="form-control" type="password" id="password" placeholder="비밀번호를 입력하세요" required
              v-model="password" :class="{'is-valid' : isValidPw, 'is-invalid' : !isValidPw}">
              <div v-if="isValidPw" class="form-text pw-text">사용할 수 있는 비밀번호입니다</div>
					    <div v-else="!isValidPw" class="form-text pw-text">영문자, 숫자 및 특수문자(@&!%*#?&) 조합의 8~15자리를 사용하세요</div>
              
              <input class="form-control" type="password" id="passwordCheck" placeholder="비밀번호 재확인" required
              v-model="passwordCheck" :class="{'is-valid' : isSamePw, 'is-invalid' : !isSamePw}">
      ...
      <div class="input-con row mb-4">
          ...
          <div class="col-sm-10">
              <input class="form-control" type="text" id="name" placeholder="이름을 입력하세요" required autocomplete="off" v-model="name">
          </div>
      </div>

      <div class="input-con row mb-4">
          <label for="nickname" class="col-sm-2 form-label">닉네임<span>*</span></label>
          <div class="col-sm-10">
      ...
      <div class="input-con row mb-4">
          <label for="email" class="col-sm-2 form-label">이메일<span>*</span></label>
          <div class="col-sm-10">
              <input class="form-control" type="email" id="email" placeholder="you@example.com" autocomplete="off" 
              v-model="email" :class="{'is-valid' : isValidEmail, 'is-invalid' : !isValidEmail}">
          </div>
      </div>
      ...
      <div class="input-con row mb-4">
          ...
          <div class="col-sm-10">
              <input class="form-control" type="text" id="tel" placeholder="휴대폰 번호(-제외)" autocomplete="off" maxlength="11" 
              v-model="tel" @input="formatPhoneNumber">
          </div>
      </div>
